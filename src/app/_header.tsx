  ...
  return (
    <header className={styles.header}>
      ...
      <p>
        ...
        interesting. Born in Hong Kong, having the second family in Tokyo Japan,
        currently based in London UK, I am a web developer embracing various
        culture, taking a people-centric approach.
      </p>
      <p>
